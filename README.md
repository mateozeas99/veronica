...
`Veronica` es una API Rest utilizada para la emisión y autorización de comprobantes electrónicos según la normativa vigente del [Sistema de Rentas Internas del Ecuador](http://www.sri.gob.ec/). El proyecto ha sido desarrollado a través de una aplicación Spring-Boot 1.5.9.RELEASE. Adicionalmente, almacena los comprobantes a través de una base de datos PostgreSQL lo cual le permite realizar consultas más allá de las elementales, como por ejemplo consultar detalles de facturas o listar comprobantes por emeisor o receptor.